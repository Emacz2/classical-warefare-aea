...
export const ExpertOpeningConstants = {
	...
	maxBerryCivilians: 8,           // hard cap for the starting berry bunch
	maxFarmCivilians: 5,            // field ResourceSupply/MaxGatherers
	maxAppleCivilians: 4            // small fruit trees should not pull a full berry group
};
