...
Trainer.prototype.Item.prototype.Queue = function(trainCostMultiplier, batchTimeMultiplier)
{
	...
	// CWA: enforce the civilization-wide cavalry percentage ceiling before
	// reserving any ordinary TrainingRestrictions category.
	const cmpPlayerCavalryLimits = QueryPlayerIDInterface(this.player, IID_CavalryLimits);
	if (cmpPlayerCavalryLimits && !cmpPlayerCavalryLimits.AllowedToTrain(this.templateName, this.count))
	{
